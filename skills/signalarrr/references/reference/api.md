<!-- Generated from website/reference/api.md by website/scripts/sync-skill.mjs. Do not edit; edit the docs page. -->
...
[Cluster-aware observables](../guide/server/backplane.md#cluster-aware-observables).
...
- [Wire Protocol](./wire-protocol.md) — message flow details
- [Packages](./packages.md) — package selection guide
