<!-- Generated from website/guide/streaming/client-to-server.md by website/scripts/sync-skill.mjs. Do not edit; edit the docs page. -->
...
- [Server-to-Client Streaming](./server-to-client.md) — stream from server to client
- [Wire Protocol](../../reference/wire-protocol.md) — stream protocol details
