<!-- Generated from website/guide/advanced/proxy-generation.md by website/scripts/sync-skill.mjs. Do not edit; edit the docs page. -->
...
- [Typed Methods](../dotnet-client/typed-methods.md) — use generated proxies on the client
- [Getting Started](../getting-started.md) — full setup walkthrough
- [Packages](../../reference/packages.md) — which packages to reference
