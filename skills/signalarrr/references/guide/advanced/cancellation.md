<!-- Generated from website/guide/advanced/cancellation.md by website/scripts/sync-skill.mjs. Do not edit; edit the docs page. -->
...
- [Server Method Handlers (TypeScript)](../typescript-client/server-methods.md) — registering handlers
- [Server-to-Client Handlers (.NET)](../dotnet-client/server-to-client.md) — .NET handler registration
- [Wire Protocol](../../reference/wire-protocol.md) — protocol message details
