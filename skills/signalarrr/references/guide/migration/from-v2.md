<!-- Generated from website/guide/migration/from-v2.md by website/scripts/sync-skill.mjs. Do not edit; edit the docs page. -->
...
The `UseHttpResponse()` option and all related code has been removed. For large data transfer, use [HTTP Stream References](../advanced/http-streams.md) instead — `Stream` parameters are automatically routed through HTTP.
...
- [Getting Started](../getting-started.md) — fresh start with v4
- [Proxy Generation](../advanced/proxy-generation.md) — source generator details
- [Authorization](../server/authorization.md) — new authorization system
