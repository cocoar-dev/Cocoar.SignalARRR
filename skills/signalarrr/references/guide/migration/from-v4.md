<!-- Generated from website/guide/migration/from-v4.md by website/scripts/sync-skill.mjs. Do not edit; edit the docs page. -->
...
See [Client Manager](../server/client-manager.md).
...
reference is the entire migration. See [Backplane & Clustering](../server/backplane.md).
...
connection. See [Authorization](../server/authorization.md).
...
deployed clients. See [Contract Wire Names](../server/contracts-wire-names.md).
...
- [Changelog](https://docs.cocoar.dev/signalarrr/changelog.html) — the full list, including everything fixed that needs no action from you
- [Client Manager](../server/client-manager.md) — the reshaped query API
- [Contract Wire Names](../server/contracts-wire-names.md) — new in v5
