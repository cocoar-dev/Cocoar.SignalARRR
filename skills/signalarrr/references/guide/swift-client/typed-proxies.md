<!-- Generated from website/guide/swift-client/typed-proxies.md by website/scripts/sync-skill.mjs. Do not edit; edit the docs page. -->
...
error, the call is simply dropped. See [Contract Wire Names](../server/contracts-wire-names.md).
...
- [Setup & Usage](./setup.md) — connection basics
- [Cancellation Propagation](../advanced/cancellation.md) — how cancellation works across clients
- [HTTP Stream References](../advanced/http-streams.md) — large file transfer
