<!-- Generated from website/guide/server/server-methods.md by website/scripts/sync-skill.mjs. Do not edit; edit the docs page. -->
...
See [Client Manager](./client-manager.md) for more details.
...
- [Client Manager](./client-manager.md) — call clients from controllers and services
- [Streaming](../streaming/server-to-client.md) — return streams from server methods
