<!-- Generated from website/guide/server/contracts-wire-names.md by website/scripts/sync-skill.mjs. Do not edit; edit the docs page. -->
...
- [Server-to-Client Handlers](../dotnet-client/server-to-client.md) — the .NET side of a contract
- [TypeScript: Server Method Handlers](../typescript-client/server-methods.md) — registering by wire name
- [Swift: Typed Proxies](../swift-client/typed-proxies.md) — same, in Swift
