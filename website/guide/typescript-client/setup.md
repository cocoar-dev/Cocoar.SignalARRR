---
description: "The @cocoar/signalarrr npm client: install, create a connection, invoke / send / stream, error handling, MessagePack, credential options (credential, connectionCredential, messageCredential), connection events and properties, method naming"
---
