...
- [Client-to-Server Streaming](/guide/streaming/client-to-server) — stream data to the server
- [Cancellation Propagation](/guide/advanced/cancellation) — remote cancellation
- [Typed Methods](/guide/dotnet-client/typed-methods) — how return types map to protocol
