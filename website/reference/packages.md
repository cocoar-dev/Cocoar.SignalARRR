---
description: "Every NuGet package, the npm package, the Swift package and the Kotlin packages: purpose and target frameworks, which project references what, typical setups per project role, the dependency graph, and the bundled agent skill"
---
